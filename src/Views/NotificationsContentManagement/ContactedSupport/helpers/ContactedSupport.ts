...
const CONTACTED_SUPPORT_FORM_SCHEMA = {
  isEnabled: {
  ...
  description: {
    ...
    label: 'Description',
    subLabel:
      'Use {{userName}} to show the name of the user who contacted support. Use {{supportMessage}} to show the message sent by the user.',
    className: 'col-md-12',
...
export default CONTACTED_SUPPORT_FORM_SCHEMA;
