...
import CONTACTED_SUPPORT_FORM_SCHEMA from './helpers/ContactedSupport';
...
function ContactedSupport() {
  ...
  const onSubmit = async (
    ...
    const payload = transformAPIRequestData(
      ...
      NOTIFICATION_TYPE.CONTACTED_SUPPORT
    );
  ...
  return (
    <CustomCardWrapper>
      <CustomForm
        id={String(NOTIFICATION_TYPE.CONTACTED_SUPPORT)}
        className="row"
        formData={CONTACTED_SUPPORT_FORM_SCHEMA}
        onSubmit={onSubmit}
...
export default ContactedSupport;
