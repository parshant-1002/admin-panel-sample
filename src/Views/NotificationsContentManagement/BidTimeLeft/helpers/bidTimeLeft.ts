...
const BID_TIME_LEFT_FORM_SCHEMA = {
  isEnabled: {
  ...
  description: {
    ...
    label: 'Description',
    subLabel:
      'Use {{auctionName}} to show the name of the auction. Use {{bidTimeLeft}} to show the time left for the auction.',
    className: 'col-md-12',
...
export default BID_TIME_LEFT_FORM_SCHEMA;
