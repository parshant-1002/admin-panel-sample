...
const AUCTION_STARTED_FORM_SCHEMA = {
  isEnabled: {
  ...
  description: {
    ...
    label: 'Description',
    subLabel:
      'Use {{auctionName}} to show the name of the auction. Use {{auctionEndDate}} to show the auction end time.',
    className: 'col-md-12',
...
export default AUCTION_STARTED_FORM_SCHEMA;
