...
export const transformAPIRequestDataSpecifications = (
...
export const transAPIRequestDataToFormSpecifications = (
  data: SpecificationsFormData // Assuming API response data might not be of type SpecificationsFormData
) => {
  return {
    modelHeader: data?.modelHeader,
