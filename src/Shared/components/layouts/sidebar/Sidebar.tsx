...
function Sidebar() {
  ...
  // Close the accordion if clicked outside
  ...
  useEffect(() => {
    // Add click listener when accordion is open and screen width is below 1200px (mobile)
      ...
      <li className="nav-item" key={`sidebar-${sidebar.label}`}>
        <Accordion activeKey={activeAccordion === sidebar.label ? '0' : ''}>
          <Accordion.Item eventKey="0">
            ...
            <Accordion.Body className="nav-content collapse show" ref={accordionRef}>
  ...
  // Recursive function for the full sidebar
